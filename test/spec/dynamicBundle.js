...
describe("Dynamic bundle Test Suite", function () {
  ...
  describe("When bundling a module that is dyanmically loaded", function () {
    ...
    describe("And the bundler has no splitters", function () {
      ...
      it("then the 'main' bundle has 5 modules", function () {
        expect(result.getModules(result.shards["main"].modules)).to.have.lengthOf(5);
      });
      ...
      it("then the 'main' bundle has the module with id '$dl$'", function () {
        expect(result.getModules(result.shards["main"].modules[4])).to.deep.include({ id: "$dl$" });
      });

      it("then the common bundle 'common-main' has 1 modules", function() {
        expect(result.getModules(result.shards["common-main.js"].modules)).to.have.lengthOf(1);
      });

      it("then the 'common-main' bundle has the module 'moriarty.js'", function () {
        expect(result.getModules(result.shards["common-main.js"].modules[0])).to.deep.include({ filename: "moriarty.js" });
      });
    ...
    describe("And the dynamically loaded module also exists in a static bundle split", function () {
      ...
      it("then result has a bundle 'common-main.js'", function () {
        expect(result.shards).to.have.property("common-main.js");
      });
      ...
      it("then the 'common-main.js' bundle has 1 modules", function () {
        expect(result.getModules(result.shards["common-main.js"].modules)).to.have.lengthOf(1);
      });

      it("then the 'common-main.js' bundle has the module 'moriarty.js'", function () {
        expect(result.getModules(result.shards["common-main.js"].modules[0])).to.deep.include({ filename: "moriarty.js" });
      });
    ...
    describe("And the dynamically loaded module also exists in a dynamic bundle split", function () {
      ...
      it("then the result has a bundle called 'common-main.js'", function () {
        expect(result.shards).to.have.property("common-main.js");
      });
      ...
      it("then the 'main' bundle has the module with id '5097a30.js' for loading `splita`", function () {
        expect(result.getModules(result.shards["main"].modules[3])).to.deep.include({ id: "5097a30.js" });
      });
    ...
    describe("And the dynamically loaded module also matches a dynamic bundle split", function () {
      ...
      it("then the 'common-main.ja' bundle has the module 'moriarty.js'", function () {
        expect(result.getModules(result.shards["common-main.js"].modules[0])).to.deep.include({ filename: "moriarty.js" });
      });
